...
# Setup 
gpt4all_path = 'D:\\Data\\Meta-Llama-3-8B-Instruct.Q4_0.gguf' 
llama_path = 'D:\\Data\\Embedding\\nomic-embed-text-v1.Q4_0.gguf' 
...
index = FAISS.load_local("./full_sotu_index", embeddings,allow_dangerous_deserialization=True)
